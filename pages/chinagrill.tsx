          ...
          <div className="lg:col-start-2 lg:pl-8">
            <div className="mx-auto max-w-prose text-base lg:ml-auto lg:mr-0 lg:max-w-lg">
              ...
              <p className="mt-8 text-lg text-gray-800">
                Howard Wang&lsquo;s China Grill made it&lsquo;s Grand Opening in
                Dallas, Texas in 2005. Since it&lsquo;s opening, locals have
                been filling up the restaurant on a daily basis for lunch and
                dinner. The unique, contemporary atmosphere in combination with
                fine Chinese dining keeps people coming back.
              </p>
              <div className="prose prose-red mt-5 text-gray-600">
                <p>
                  Howard Wang&lsquo;s China Grill has had overwhelming success
                  and extremely high rate of return visitors.
                </p>
                <h3>How we&lsquo;re different</h3>
                <p>
                  The ultra contemporary atmosphere brings customers a feeling
                  of relaxation and comfort while dining with family and
                  friends. The food speaks for itself and is made only with the
                  finest ingredients.
                </p>
              </div>
            </div>
